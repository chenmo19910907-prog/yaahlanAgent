#!/usr/bin/env python3
"""根据 config/registry.json 生成 MSE/使用方法.md。"""
...
from mse.paths import mse_dir, registry_path, usage_doc_path
...
def main() -> int:
    ...
    if isinstance(out_rel, str) and out_rel.strip():
        repo_root = os.path.dirname(mse_dir())
    ...
    _sync_platform_catalog(os.path.dirname(mse_dir()))
    return 0

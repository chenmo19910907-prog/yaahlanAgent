...
_REPO = repo_root()
_SERVICE_URL = service_url("diamondHistoryService", "/service/yaahlan/components/wallet-api")
_METHOD = "diamondHistory"
_TEMPLATE_BODY = load_body_template("templates/example-diamondHistory.body.json")

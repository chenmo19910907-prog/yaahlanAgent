...
- [10) 用户后门（voga-mts-user-backdoor）](#moa-cat-10)
  - [用户-注销账号](#user_cancel_real)
- [11) 用户大区（yaahlan/components/callback/user-area）](#moa-cat-11)
  - [用户-修改大区](#user_area_change)
- [12) 用户活跃（yaahlan/user/internal/area-moa）](#moa-cat-12)
  - [用户-查询登录天数](#user_active_days_query)
- [13) 用户登录（yaahlan/mdp-user-login）](#moa-cat-13)
  - [用户-按手机号查 userId](#user_login_query_by_phone)
- [14) 用户资料（voga-mts-user-profile-stage）](#moa-cat-14)
  - [用户-查看 app 语言](#user_app_language_query)
- [15) 背包礼物（voga-base-service-middle-gift-stage）](#moa-cat-15)
  - [背包礼物-下发](#package_gift_add)
- [16) 贵族（voga-mts-user-wealth-charm-level-stage）](#moa-cat-16)
  - [贵族-升级到目标等级](#noble_level_upgrade)
  - [贵族-增加月消费值](#noble_exp_add)
- [17) 钻石（voga-base-service-middle-pay-stage）](#moa-cat-17)
...
## 10) 用户后门（voga-mts-user-backdoor）
...
## 11) 用户大区（yaahlan/components/callback/user-area）
...
## 12) 用户活跃（yaahlan/user/internal/area-moa）
...
## 13) 用户登录（yaahlan/mdp-user-login）
...
## 14) 用户资料（voga-mts-user-profile-stage）
...
## 15) 背包礼物（voga-base-service-middle-gift-stage）
...
## 16) 贵族（voga-mts-user-wealth-charm-level-stage）
...
## 17) 钻石（voga-base-service-middle-pay-stage）
